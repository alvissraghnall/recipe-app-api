...
import io.alviss.recipe_api.recipe_api.auth.MessageResponse;
import io.alviss.recipe_api.recipe_api.config.cloudinary.CloudinaryService;
...
public class RecipeResource {
    ...
    public ResponseEntity<RecipeDTO> createRecipe(@RequestBody @Valid final RecipeDTO recipeDTO) {
